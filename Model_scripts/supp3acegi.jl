...
plot_reproductive_rate(5, 20000, "$figure_directory/supplemental/supp_3c.png")
# plot the average V0
plot_vertical_reproductive_ratio(1, 20000, "$figure_directory/supplemental/supp_3e.png")
# plot the average horizontal transmission
plot_horizontal_and_virulence(1, 20000, "$figure_directory/supplemental/supp_3g.png")
# plot the evenness through time
plot_evenness(1, 20000, "$figure_directory/supplemental/supp_3i.png")
