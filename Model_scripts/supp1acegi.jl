...
plot_reproductive_rate(6, 5000, "$figure_directory/supplemental/supp_1c.png")
# plot the average weighted V0
plot_vertical_reproductive_ratio(1, 5000, "$figure_directory/supplemental/supp_1e.png")
# plot the weighted average mortality rate through time
plot_mortality(1, 5000, "$figure_directory/supplemental/supp_1g.png")
# plot the evenness through time
plot_evenness(1, 5000, "$figure_directory/supplemental/supp_1i.png")
