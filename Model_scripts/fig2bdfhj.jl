...
plot_reproductive_rate(5, ncol(Np), "$figure_directory/graph_2d.png")
########### Figure 2f ###########
# plot the average V0
plot_vertical_reproductive_ratio(1, ncol(Np), "$figure_directory/graph_2f.png")
########### Figure 2h ###########
...
plot_horizontal_and_virulence(1, ncol(Np), "$figure_directory/graph_2h.png")
########### Figure 2j ###########
# calculate & plot the population evenness through time
plot_evenness(1, ncol(Np), "$figure_directory/graph_2j.png")
