...
plot_reproductive_rate(5, ncol(Np), "$figure_directory/graph_3c.png")
########### Figure 3e ###########
# plot the average V0
plot_vertical_reproductive_ratio(1, ncol(Np), "$figure_directory/graph_3e.png")
########### Figure 3g ###########
...
plot_horizontal_and_virulence(1, ncol(Np), "$figure_directory/graph_3g.png")
########### Figure 3i ###########
# calculate & plot the population evenness through time
plot_evenness(1, ncol(Np), "$figure_directory/graph_3i.png")
