...
plot_reproductive_rate(6, 5000, "$figure_directory/supplemental/supp_1d.png")
# plot the average weighted V0
plot_vertical_reproductive_ratio(1, 5000, "$figure_directory/supplemental/supp_1f.png")
# plot the weighted average mortality rate through time
plot_mortality(1, 5000, "$figure_directory/supplemental/supp_1h.png")
# plot the evenness through time
plot_evenness(1, 5000, "$figure_directory/supplemental/supp_1j.png")
