...
plot_reproductive_rate(5, 5e3, "$figure_directory/supplemental/supp_2d.png")
# plot the average V0
plot_vertical_reproductive_ratio(1, 5e3, "$figure_directory/supplemental/supp_2f.png")
# plot the average weighted horizontal transmission
plot_horizontal_and_virulence(1, 5e3, "$figure_directory/supplemental/supp_2h.png")
# plot the evenness through time
plot_evenness(1, 5e3, "$figure_directory/supplemental/supp_2j.png")
