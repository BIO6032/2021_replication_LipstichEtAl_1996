...
V0_w = calculate_V0()
# plot the average V0
plot_vertical_reproductive_ratio(1, ncol(Np), "$figure_directory/graph_2e.png")
########### Figure 2c ###########
...
plot_reproductive_rate(5, ncol(Np), "$figure_directory/graph_2c.png")
########### Figure 2g ###########
...
plot_horizontal_and_virulence(1, ncol(Np), "$figure_directory/graph_2g.png")
########### Figure 2i ###########
# calculate & plot the population evenness through time
plot_evenness(1, ncol(Np), "$figure_directory/graph_2i.png")
