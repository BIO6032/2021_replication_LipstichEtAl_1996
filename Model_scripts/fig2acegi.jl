...
plot_population_numbers(
    ...
    png_path="$figure_directory/graph_2a.png"
)
########### Figure 2e ###########
...
plot_vertical_reproductive_ratio(
    data=V0_w,
    png_path="$figure_directory/graph_2e.png"
)
########### Figure 2c ###########
...
plot_reproductive_rate(
    data=H0_w + V0_w,
    upper_y_limit=5,
    png_path="$figure_directory/graph_2c.png"
)
########### Figure 2g ###########
...
plot_horizontal_and_virulence(
    βy_data=βy_w_avg,
    vir_data=vir_w_avg,
    png_path="$figure_directory/graph_2g.png"
)
########### Figure 2i ###########
# calculate & plot the population evenness through time
plot_evenness(data=Np, png_path="$figure_directory/graph_2i.png")
