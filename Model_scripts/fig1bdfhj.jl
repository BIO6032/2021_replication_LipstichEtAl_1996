...
plot_mortality(1, ncol(Np), "$figure_directory/graph_1h.png")
########### Figure 1f ###########
...
plot_vertical_reproductive_ratio(1, ncol(Np), "$figure_directory/graph_1f.png")
########### Figure 1d ###########
# plot the average weighted R0
plot_reproductive_rate(6, ncol(Np), "$figure_directory/graph_1d.png")
########### Figure 1j ###########
# calculate & plot the population evenness through time
plot_evenness(1, ncol(Np), "$figure_directory/graph_1j.png")
