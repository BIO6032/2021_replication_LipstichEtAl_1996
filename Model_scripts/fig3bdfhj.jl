...
plot_reproductive_rate(5, ncol(Np), "$figure_directory/graph_3d.png")
########### Figure 3f ###########
# plot the average V0
plot_vertical_reproductive_ratio(1, ncol(Np), "$figure_directory/graph_3f.png")
########### Figure 3h ###########
...
plot_horizontal_and_virulence(1, ncol(Np), "$figure_directory/graph_3h.png")
########### Figure 3j ###########
# calculate & plot the population evenness through time
plot_evenness(1, ncol(Np), "$figure_directory/graph_3j.png")
