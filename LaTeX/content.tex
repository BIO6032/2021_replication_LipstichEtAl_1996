...
\begin{figure}[tbph]
    \centering
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1a.png}\label{fig:1a}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1b.png}\label{fig:1b}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1c.png}\label{fig:1c}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1d.png}\label{fig:1d}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1e.png}\label{fig:1e}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1f.png}\label{fig:1f}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1g.png}\label{fig:1g}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1h.png}\label{fig:1h}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1i.png}\label{fig:1i}}
    \hfil
...
\begin{figure}[tbp]
    \centering
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2a.png}\label{fig:2a}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2b.png}\label{fig:2b}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2c.png}\label{fig:2c}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2d.png}\label{fig:2d}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2e.png}\label{fig:2e}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2f.png}\label{fig:2f}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2g.png}\label{fig:2g}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2h.png}\label{fig:2h}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2i.png}\label{fig:2i}}
    \hfil
...
\begin{figure}[tbp]
    \centering
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3a.png}\label{fig:3a}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3b.png}\label{fig:3b}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3c.png}\label{fig:3c}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3d.png}\label{fig:3d}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3e.png}\label{fig:3e}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3f.png}\label{fig:3f}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3g.png}\label{fig:3g}}
    \hfil
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3h.png}\label{fig:3h}}

    \medskip
        \subfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3i.png}\label{fig:3i}}
    \hfil
