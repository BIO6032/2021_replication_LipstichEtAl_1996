...
\begin{figure}[tbph]
    \centering
        \sidesubfloat[a]{\includegraphics[width=0.4\textwidth]{figures/graph_1a.png}\label{fig:1a}}
    \hfil
        \sidesubfloat[b]{\includegraphics[width=0.4\textwidth]{figures/graph_1b.png}\label{fig:1b}}

    \medskip
        \sidesubfloat[c]{\includegraphics[width=0.4\textwidth]{figures/graph_1c.png}\label{fig:1c}}
    \hfil
        \sidesubfloat[d]{\includegraphics[width=0.4\textwidth]{figures/graph_1d.png}\label{fig:1d}}

    \medskip
        \sidesubfloat[e]{\includegraphics[width=0.4\textwidth]{figures/graph_1e.png}\label{fig:1e}}
    \hfil
        \sidesubfloat[f]{\includegraphics[width=0.4\textwidth]{figures/graph_1f.png}\label{fig:1f}}

    \medskip
        \sidesubfloat[g]{\includegraphics[width=0.4\textwidth]{figures/graph_1g.png}\label{fig:1g}}
    \hfil
        \sidesubfloat[h]{\includegraphics[width=0.4\textwidth]{figures/graph_1h.png}\label{fig:1h}}

    \medskip
        \sidesubfloat[i]{\includegraphics[width=0.4\textwidth]{figures/graph_1i.png}\label{fig:1i}}
    \hfil
        \sidesubfloat[j]{\includegraphics[width=0.4\textwidth]{figures/graph_1j.png}\label{fig:1j}}
...
\begin{figure}[tbp]
    \centering
        \sidesubfloat[a]{\includegraphics[width=0.4\textwidth]{figures/graph_2a.png}\label{fig:2a}}
    \hfil
        \sidesubfloat[b]{\includegraphics[width=0.4\textwidth]{figures/graph_2b.png}\label{fig:2b}}

    \medskip
        \sidesubfloat[c]{\includegraphics[width=0.4\textwidth]{figures/graph_2c.png}\label{fig:2c}}
    \hfil
        \sidesubfloat[d]{\includegraphics[width=0.4\textwidth]{figures/graph_2d.png}\label{fig:2d}}

    \medskip
        \sidesubfloat[e]{\includegraphics[width=0.4\textwidth]{figures/graph_2e.png}\label{fig:2e}}
    \hfil
        \sidesubfloat[f]{\includegraphics[width=0.4\textwidth]{figures/graph_2f.png}\label{fig:2f}}

    \medskip
        \sidesubfloat[g]{\includegraphics[width=0.4\textwidth]{figures/graph_2g.png}\label{fig:2g}}
    \hfil
        \sidesubfloat[h]{\includegraphics[width=0.4\textwidth]{figures/graph_2h.png}\label{fig:2h}}

    \medskip
        \sidesubfloat[i]{\includegraphics[width=0.4\textwidth]{figures/graph_2i.png}\label{fig:2i}}
    \hfil
        \sidesubfloat[j]{\includegraphics[width=0.4\textwidth]{figures/graph_2j.png}\label{fig:2j}}
\caption{\textbf{Evolutionary dynamics of 100 infected strains introduced every
...
\begin{figure}[tbp]
    \centering
        \sidesubfloat[a]{\includegraphics[width=0.4\textwidth]{figures/graph_3a.png}\label{fig:3a}}
    \hfil
        \sidesubfloat[b]{\includegraphics[width=0.4\textwidth]{figures/graph_3b.png}\label{fig:3b}}

    \medskip
        \sidesubfloat[c]{\includegraphics[width=0.4\textwidth]{figures/graph_3c.png}\label{fig:3c}}
    \hfil
        \sidesubfloat[d]{\includegraphics[width=0.4\textwidth]{figures/graph_3d.png}\label{fig:3d}}

    \medskip
        \sidesubfloat[e]{\includegraphics[width=0.4\textwidth]{figures/graph_3e.png}\label{fig:3e}}
    \hfil
        \sidesubfloat[f]{\includegraphics[width=0.4\textwidth]{figures/graph_3f.png}\label{fig:3f}}

    \medskip
        \sidesubfloat[g]{\includegraphics[width=0.4\textwidth]{figures/graph_3g.png}\label{fig:3g}}
    \hfil
        \sidesubfloat[h]{\includegraphics[width=0.4\textwidth]{figures/graph_3h.png}\label{fig:3h}}

    \medskip
        \sidesubfloat[i]{\includegraphics[width=0.4\textwidth]{figures/graph_3i.png}\label{fig:3i}}
    \hfil
        \sidesubfloat[j]{\includegraphics[width=0.4\textwidth]{figures/graph_3j.png}\label{fig:3j}}
\caption{\textbf{Evolutionary dynamics of 100 infected strains introduced every
