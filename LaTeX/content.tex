...
In this study, we successfully replicate the epidemiological model incorporating trade-offs between vertical and horizontal transmission from the original study by Lipsitch et al. (1996)\supercite{Lipsitch:1996} using their methods and parameters.
...
\begin{figure}[tbph]
    \centering
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1a.png}\label{fig:a}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1b.png}\label{fig:b}}

    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1c.png}\label{fig:c}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1d.png}\label{fig:d}}

    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1e.png}\label{fig:e}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1f.png}\label{fig:f}}

    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1g.png}\label{fig:g}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1h.png}\label{fig:h}}
        
    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1i.png}\label{fig:i}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_1j.png}\label{fig:j}}
...
\begin{figure}[tbp]
    \centering
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2a.png}\label{fig:a}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2b.png}\label{fig:b}}

    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2c.png}\label{fig:c}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2d.png}\label{fig:d}}

    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2e.png}\label{fig:e}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2f.png}\label{fig:f}}

    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2g.png}\label{fig:g}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2h.png}\label{fig:h}}
        
    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2i.png}\label{fig:i}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_2j.png}\label{fig:j}}
...
\begin{figure}[tbp]
    \centering
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3a.png}\label{fig:a}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3b.png}\label{fig:b}}

    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3c.png}\label{fig:c}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3d.png}\label{fig:d}}

    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3e.png}\label{fig:e}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3f.png}\label{fig:f}}

    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3g.png}\label{fig:g}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3h.png}\label{fig:h}}
        
    \medskip
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3i.png}\label{fig:i}}
    \hfil
        \sidesubfloat[]{\includegraphics[width=0.4\textwidth]{figures/graph_3j.png}\label{fig:j}}
