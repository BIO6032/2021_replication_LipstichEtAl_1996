...
ey = fill(0.9, n_parasites);    # constant for fig 2 part 1, ey = bx - by
...
plot(V0,c=:black, title = "Average V0 in the population", xlabel = "Time", ylabel = "Mean V0", leg = false, ylims=(0,1))
